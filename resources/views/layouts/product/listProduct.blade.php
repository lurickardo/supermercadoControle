        ...
        <div class="card">
                ...
                <form method="POST" action="/product/search">
                    ...
                    <div class="d-flex bd-highlight mb-4">
                        ...
                        <div id="texts" class="p-2 bd-highlight col-md-3">
                            <input type="text" class="form-control" id="nmTitle" name="nmTitle" placeholder="Buscar por título do produto" maxlength="50">
                        </div>
                        <div id="texts" class="p-2 bd-highlight col-md-3">
            ...
            <div class="table-responsive">
                ...
                <div class="d-flex justify-content-center">
                    {!! isset($filters) ? $products->appends($filters)->links('vendor.pagination.tailwind') : $products->links('vendor.pagination.tailwind') !!}
                </div>
            </div>
        </div>
    </div>
