    ...
    <div class="col-sm-8 container sm:my-10">
        <div class="card">
            <div class="card-body text-left">
                ...
                <form method="post" action="/category/create/register">
                    @csrf
                    <div class="form-group sm:my-2">
                        <label for="titleCategory">Título da categoria: </label>
                        <input type="text" class="form-control" name="nmTitle" id="nmTitle" placeholder="Digite o título da categoria" maxlength="50">
                    </div>
