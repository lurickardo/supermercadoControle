                    ...
                    <div class="p-6">
                        <a href="https://laracasts.com">
                            <div class="flex items-center">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-blue-400">
                    ...
                    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                        <a href="https://laracasts.com">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">Laracasts</div>
                            </div>
                        </a>
                    </div>
